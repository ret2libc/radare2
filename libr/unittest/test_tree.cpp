...
bool test_r_tree() {
	...
	r_tree_reset(t);
	RTreeNode *root = r_tree_add_node(t, NULL, (void *)"root");
	RTreeNode *first = r_tree_add_node(t, root, (void *)"first");
	r_tree_add_node(t, root, (void *)"second");
	r_tree_add_node(t, root, (void *)"third");
	r_tree_add_node(t, first, (void *)"f_first");
	r_tree_add_node(t, first, (void *)"f_second");

	RList *exp3 = r_list_new();
	r_list_append(exp3, (void *)"root");
	r_list_append(exp3, (void *)"first");
	r_list_append(exp3, (void *)"f_first");
	r_list_append(exp3, (void *)"f_second");
	r_list_append(exp3, (void *)"second");
	r_list_append(exp3, (void *)"third");
	lister.data = r_list_new();
	r_tree_dfs(t, &lister);
